...
$ress = mysqli_query($cnx,"SELECT * FROM `form` WHERE ");
     ...
     echo $data['navb']?>" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a id="urls" class="navbar-brand" href="inphp">Start Bootstrap</a>
            </div>
            <!-- Right -->
...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <!-- Contact form -->
                <form name="sentMessage" action="contactCible.php" method="POST" id="contactForm" enctype="multipart/form-data">
                    ...
                    <div class="control-group form-group" >
                        <div class="controls">
                            <label>jeux:</label>
                                 <select type="text" name="jeux">
                                     <option> CAll OF DUTY</option>
                                         <option>BATEFLIED</option>
                                             <option>FARCRY</option>
                    ...
                    <div class="control-group form-group" name="">
                        <div class="controls">
                            <label>Date de naissance:</label>
                            <input type="text" class="form-control" id="email" name="date">
                        </div>
                    </div>
